"""Train a model on SQuAD.
            print(ones.shape, self.c_posner.shape)
...
def main(args):
    ...
    model = BiDAF(word_vectors=word_vectors, char_vectors=char_vectors,
                  ...
                  enable_selfatt=args.enable_selfatt,
                  beta_selfatt = args.beta_selfatt)
...
#    )
    ...
    while epoch != args.num_epochs:
        ...
        with torch.enable_grad(), \
            ...
            for cw_idxs, cc_idxs, qw_idxs, qc_idxs, y1, y2, ids, cwf, lemma_indicators, c_posner, q_posner in train_loader:
                # Setup for forward

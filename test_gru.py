...
from models import BiDAF, BiDAF_GRU
...
#                   hidden_size=args.hidden_size, enable_EM=args.enable_EM)
    
    model = BiDAF_GRU(word_vectors=word_vectors, hidden_size=args.hidden_size)
